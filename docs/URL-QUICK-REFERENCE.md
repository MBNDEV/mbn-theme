...
3. Enter your URLs in the two simple fields:
   - **🏠 Local Development URL**: `https://blacklineguardianfund.dev.local`
   - **🌐 Deployment Server URL**: `https://staging2.blacklineguardianfund.com`
...
**Example:**
```
FROM: https://blacklineguardianfund.dev.local/wp-content/uploads/2026/04/hero.jpg
TO:   https://staging2.blacklineguardianfund.com/wp-content/uploads/2026/04/hero.jpg
```
...
```bash
cd wp-content/themes/blacklineguardianfund-theme

# Dry run (preview only)
php scripts/replace-domains.php \
  --from="blacklineguardianfund.dev.local" \
  --to="staging2.blacklineguardianfund.com" \
  --dry-run
