...
$defaults      = json_decode( file_get_contents( __DIR__ . '/block.json' ), true ); // phpcs:ignore WordPress.WP.AlternativeFunctions.file_get_contents_file_get_contents -- Local file read
$default_attrs = array();
...
<div <?php echo $wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped by get_block_wrapper_attributes ?>>
	...
	<div class="<?php echo esc_attr( $content_class ); ?>">
		...
		<?php if ( ! empty( $attributes['buttonText'] ) ) : ?>
			<a class="mbn-icon-box__button btn-<?php echo esc_attr( $button_variant ); ?>" href="<?php echo esc_url( ! empty( $attributes['buttonUrl'] ) ? $attributes['buttonUrl'] : '#' ); ?>" target="<?php echo esc_attr( '_blank' === ( $attributes['buttonTarget'] ?? '' ) ? '_blank' : '_self' ); ?>" <?php echo '_blank' === ( $attributes['buttonTarget'] ?? '' ) ? 'rel="noopener noreferrer"' : ''; ?> style="<?php echo esc_attr( $style_string( $button_style ) ); ?>">
